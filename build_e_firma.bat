...
"%SIGNTOOL_PATH%" sign /tr http://time.certum.pl/ /td sha256 /fd sha256 /a "Installer\Foliarium_1.2_Setup.exe"
if %errorlevel% neq 0 (
...
echo.
echo ==============================================================
echo   SUCCESSO! FOLIARIUM E' COMPILATO E FIRMATA DIGITALMENTE.
echo ==============================================================
