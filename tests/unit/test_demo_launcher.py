...
from foliarium.core.services.demo_launcher import (
    DEMO_PG_PORT,
    DEMO_PG_SUPERUSER,
    EmbeddedPostgres,
    _bundle_root,
...
class TestBundleRoot:
    ...
    @patch("foliarium.core.services.demo_launcher.sys")
...
class TestPgsqlBin:
    ...
    @patch("foliarium.core.services.demo_launcher._bundle_root")
...
class TestWritableDataDir:
    @patch("foliarium.core.services.demo_launcher._default_data_dir_source")
    ...
    @patch("foliarium.core.services.demo_launcher.shutil.copytree")
    @patch("foliarium.core.services.demo_launcher._default_data_dir_source")
...
class TestIsEmbeddedAvailable:
    @patch("foliarium.core.services.demo_launcher._default_data_dir_source")
    @patch("foliarium.core.services.demo_launcher._pgsql_bin")
...
class TestEmbeddedPostgres:
    ...
    @patch("foliarium.core.services.demo_launcher._pgsql_bin", return_value=None)
    ...
    @patch("foliarium.core.services.demo_launcher.subprocess.run")
    @patch("foliarium.core.services.demo_launcher._writable_data_dir")
    @patch("foliarium.core.services.demo_launcher._default_data_dir_source")
    @patch("foliarium.core.services.demo_launcher._pgsql_bin")
...
class TestModuleLevelFunctions:
    @patch("foliarium.core.services.demo_launcher.EmbeddedPostgres")
    ...
    @patch("foliarium.core.services.demo_launcher._embedded_pg", None)
