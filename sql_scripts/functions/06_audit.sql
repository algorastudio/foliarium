...
-- Trigger di audit, funzione log_audit_trigger_function, vista v_audit_dettagliato.
-- Include integrazione FK audit_log → utente.
-- Versione: Foliarium v1.7.0+

-- ========================================================================
-- DA: 18_funzioni_trigger_audit.sql — contenuto completo
-- ========================================================================
...
SELECT
    al.id,
    -- Formatta il timestamp per rimuovere i millisecondi
...
-- ========================================================================
-- DA: 15_integration_audit_users.sql — SOLO le istruzioni ALTER TABLE / ADD CONSTRAINT
-- che collegano audit_log.app_user_id a utente
-- ========================================================================
