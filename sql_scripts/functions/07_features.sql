...
-- Funzioni per feature avanzate: nomi storici, documenti storici,
-- albero genealogico proprietà, statistiche per periodo.
-- Versione: Foliarium v1.7.0+

-- ========================================================================
-- DA: 11_advanced-cadastral-features.sql — SOLO FUNZIONI (senza CREATE TABLE)
-- ========================================================================
